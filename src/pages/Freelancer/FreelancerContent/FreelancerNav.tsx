        ...
        <div className="relative py-4 transition-all duration-300">
          <div className="flex items-center justify-between">
            ...
            <div className="lg:flex gap-5 items-center hidden">
              <div className="flex gap-1 underline items-center dark:text-text_primary">
          ...
          >
            <ul className="flex flex-col mt-10 text-center items-center pt-10  h-full">
              ...
              <div className="flex mt-5 items-center gap-1 border text-white dark:border-primary p-3 md:p-3">
